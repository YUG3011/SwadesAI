...
import { addMessage, dropConversation, grabConversationById, grabConversationList, makeConversation, } from '../services/conversation.service.js';
...
chatBook.post('/messages', zValidator('json', messageShape), async (context) => {
    ...
    return streamText(context, async (writer) => {
        await writer.write(JSON.stringify({ conversationId: activeConversationId, agentType: agentOutcome.agentType, thinking: thinkingNotes }));
